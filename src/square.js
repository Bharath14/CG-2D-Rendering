export default class Square {
    constructor(gl, centerX, centerY, color = "default") 
    {
        ...
        this.vertexAttributesData = new Float32Array([
            //  x , y,  z
            centerX + 0.05, centerY + 0.05, 0.0,    // Drawing a square each side with 0.1 unit length.
            centerX + 0.05, centerY - 0.05, 0.0,
            centerX - 0.05, centerY + 0.05, 0.0,
            centerX - 0.05, centerY - 0.05, 0.0,
        ]);
    ...
    draw(shader)
    {
        ...
        this.vertexAttributesData = new Float32Array([
            //x,Y,Z
            this.coordinates[0] + 0.05 * (this.size), this.coordinates[1] + 0.05* (this.size), 0.0,
            this.coordinates[0] + 0.05 * (this.size), this.coordinates[1] - 0.05 * (this.size), 0.0,
            this.coordinates[0] - 0.05 * (this.size), this.coordinates[1] + 0.05 * (this.size), 0.0,
            this.coordinates[0] - 0.05 * (this.size), this.coordinates[1] - 0.05 * (this.size), 0.0,
        ]);
